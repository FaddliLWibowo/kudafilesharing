				...
				?>
						<tr>
							...
							<td>
								...
								<a href="<?php echo $url ?>ikifilesharingom/aksi_hapus_file/<?php echo $idfile ?>/<?php echo $idfolder ?>/<?php echo $iduser ?>/<?php echo $namafile ?>" title="Delete" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?');" ><img src="<?php echo $url ?>public/images/delete.png" width="40" height="40" /></a>
							</td>
						</tr>
				<?php
					}

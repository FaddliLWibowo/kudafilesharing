	  ...
	  ?>
				...
				<div class="row-fluid">
					<div class="span4 offset4 alert alert-success">
						<button type="button" class="close" data-dismiss="alert">×</button><?php echo $this->session->flashdata('deleteuser') ?>
					</div>
				</div>
				</center>
	  <?php
			...
			<table class="table table-striped" >
				...
				?>
						<tr>
							...
							<td><?php echo $pass ?></td>
							<td>
								<a href="<?php echo $url ?>kowengawurog/hapus_user/<?php echo $row->iduser ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?');" title="Hapus User"><img src="<?php echo $url ?>public/images/delete.png" width="40" height="40" /></a>
							</td>
						</tr>
				<?php
						$no++;

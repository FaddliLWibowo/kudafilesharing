      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="<?php echo base_url(); ?>kowengawurog/cpanel">Home</a></li>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
		...
		<div class="span4">
			<?php
				$form = array(
					'name' => 'form_tambah_hak',
					'method' => 'post'
				);
			?>
			<?php echo form_open('kowengawurog/aksi_edit_hak_akses', $form); ?>
			<?php
				foreach($hak as $row) {
					$id = $row->id_ha;
					$nama = $row->nama;
			?>
				<table >
					<tr>
						...
						<td>:</td>
						<td>
							<input type="text" name="hak" value="<?php echo $nama; ?>" />

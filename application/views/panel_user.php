  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
		...
		<div class="row">
		<div class="span4">
			<a href="<?php echo base_url() ?>ikifilesharingom/file_saya"><img src="<?php echo base_url() ?>public/images/tambah_folder.png" title="File Saya" /></a><br/><br/>
			<a class="btn btn-large" href="<?php echo base_url() ?>ikifilesharingom/file_saya">File Saya</a>
		</div>
		</div>
	  </div>
